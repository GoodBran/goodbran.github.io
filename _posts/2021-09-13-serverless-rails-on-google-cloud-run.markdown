...
- A little bit familiarity about GCP.
...
![Rails test home page](/assets/images/rails-homepage-local.webp)
...
![GCP SQL admin panel](/assets/images/gcp-sql-instances.webp)
...
![Database and user creation](/assets/images/gcp-sql-database-creation.webp)
...
![Instance connection name](/assets/images/gcp-sql-connection-name.webp)
...
![GCP Secrets Manager](/assets/images/gcp-secrets-manager.webp)
...
![Cloud build status](/assets/images/gcp-cloud-build-success.webp)
...
![Cloud registry deploy](/assets/images/gcp-cloud-registry-deploy.webp)

![Cloud run service connection](/assets/images/gcp-cloud-run-sql-connection.webp)
...
![Home page running on HTTPS](/assets/images/rails-homepage-production.webp)
...
![Uptime check configuration](/assets/images/gcp-uptime-check.webp)

### Step 9 - Setup automatic docker image builder pipeline

There are many CI/CD tools available in the market, here I am using the continuous cloud build server offered by Google. Whenever a new version tag is pushed to the github, a new build will be triggered on the google platform. If you want to deploy the new image, you should go to the cloud run dashboard and replace the image manually.
